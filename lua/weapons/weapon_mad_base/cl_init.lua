...
local function GetHit( IsNPC )

if NPCHitmarkers:GetBool() == true and IsNPC:ReadBool() == true then
...
if PlayerHitmarkers:GetBool() == true and IsNPC:ReadBool() == false then
...
usermessage.Hook( "Hitmarkers.hit", GetHit )
